...
M16 is a 16-bit audio synthesis library for selected microcontrollers and I2S audio DACs/ADCs. It also supports internal DACs on ESP32 processor variants that have them.
...
Always include the M16.h file and add a void audioUpdate() function that ends with a call to audoBlockWrite(leftVal, rightVal). This function is automatically called in the background.
...
M16 is inspired by the 8-bit Mozzi audio library (Tim Barrass, 2012). 
