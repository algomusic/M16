...
static const i2s_pin_config_t pin_config = { // D1 mini, NodeMCU
    .bck_io_num = 25, //25, //25,     // 25    // 8   // 6                     // The bit clock connectiom, goes to pin 27 of ESP32
    .ws_io_num = 27, //27, //27,       //27    // 6   // 4                // Word select, also known as word select or left right clock
    .data_out_num = 12, //12, //12,     //26   // 7   // 5            // Data out from the ESP32, connect to DIN on 38357A
